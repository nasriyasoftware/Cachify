...
export class FileEventsManager {
    ...
    readonly emit = {
        ...
        contentSizeChange: async (record: FileCacheRecord, delta: number) => {
            const payload: FileContentSizeChangeEvent = { item: record.toJSON(), flavor: record.flavor, type: 'fileContentSizeChange', delta: delta };
...
const fileEventsManager = new FileEventsManager();
export default fileEventsManager;