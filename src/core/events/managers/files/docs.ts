...
import { CacheEvent, CacheEvents, CreateEvent, DirectRemovalSource, EvictReason, ReadEvent, RemovalReason, RemoveEvent, UpdateEvent, TouchEvent, HitEvent, MissEvent, FilesInvalidateReason } from "../../docs";

export type FileCacheEvent = Extract<CacheEvent<FileCacheRecord>, 'create' | 'read' | 'update' | 'clear' | 'evict' | 'expire' | 'hit' | 'miss' | 'touch' | 'invalidate' | 'remove' | 'fileContentSizeChange'>;
