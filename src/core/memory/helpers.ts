...
import KVCacheRecord from "./kv/record";
    ...
    readonly cacheManagement = {
        ...
        eviction: {
            async evictIfEnabled<T extends CacheRecord>(
                ...
                if (!(eventsManager instanceof FileEventsManager || eventsManager instanceof KVEventsManager)) {
                    throw new TypeError('eventsManager must be a FileEventsManager or KVEventsManager');
                }
                // =======
